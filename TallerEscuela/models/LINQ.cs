            ...
            while (bandera)
            {
                ...
                switch (opcion)
                {
                    ...
                    case "1":
                        ...
                        AdministradorApp.MostrarEstudiantes(promedioMayor85);
                    ...
                    case "2":
                        ...
                        AdministradorApp.MostrarProfesores(profesoresMasDeUnCurso);
                        AdministradorApp.PausarMenu();
                        break;
                    case "3":
                        var edadMayor16 = Estudiantes.Where(estudiante => estudiante.Edad > 16).ToList();
                        Console.WriteLine($"Estudiantes con edad mayor a 16: ");
                        AdministradorApp.MostrarEstudiantes(edadMayor16);
                        AdministradorApp.PausarMenu();
                        break;
                    case "4":
                        ...
                        AdministradorApp.MostrarEstudiantes(estudiantesOrdenados);
                        AdministradorApp.PausarMenu();
                        break;
                    case "5":
                    ...
                    case "8":
                        ...
                        AdministradorApp.MostrarProfesores(profesoresMas10años);
                        AdministradorApp.PausarMenu();
                        break;
                    case "9":  
                        Console.WriteLine("No fue posible, intenta de nuevo más tarde");
                    ...
                    case "10":
                        ...
                        Console.WriteLine($"Estudiantes con promedio mayor a 85: ");
                        AdministradorApp.MostrarEstudiantes(estudiantesAcudienteMaria);
                        AdministradorApp.PausarMenu();
                        break;
                    case "11":
                        ...
                        AdministradorApp.MostrarProfesores(profesoresOrdenadosSalario);
                        AdministradorApp.PausarMenu();
                        break;
                    case "12":
                        var promedioEdad = Estudiantes.Average(estudiante => estudiante.Edad);
                    ...
                    case "13":
                        ...
                        AdministradorApp.MostrarProfesores(profesoresMatematicas);
                        AdministradorApp.PausarMenu();
                        break;
                    case "14":
                        ...
                        AdministradorApp.MostrarEstudiantes(estudiantesMas3Calificaciones);
                        AdministradorApp.PausarMenu();
                        break;
                    case "15":
